...
- [视频显示/MIPI C-PHY](../知识/视频显示/MIPI C-PHY.md) — 知识页
- [视频显示/MIPI D-PHY](../知识/视频显示/MIPI D-PHY.md) — 同类物理层对比
- [视频显示/MIPI DSI](../知识/视频显示/MIPI DSI.md) — 上层协议（可用 C-PHY 作为 PHY）
- [视频显示/MIPI 概述](../知识/视频显示/MIPI 概述.md) — MIPI 家族全景
