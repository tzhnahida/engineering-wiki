...
[📷 _llm/raw/assets/datasheets/tps55288/tps55288_p15_fig1.jpg|620]
*功能方框图（数据手册 §7.2）：四开关 Buck-Boost 功率级 + I²C 接口*

- **四开关 Buck-Boost** 拓扑 → [DC-DC降压转换器](DC-DC降压转换器.md)（buck 原理的延伸：buck、boost 两桥臂共用一颗电感）
...
- **PFM/FPWM 双模式** → [轻载效率模式](轻载效率模式.md)
- **展频 ±7% + 外部时钟同步** → [展频谱与EMI抑制](展频谱与EMI抑制.md)
- **保护**：可编程 UVLO、平均+峰值双重限流、输出恒流环、OVP、短路打嗝、热关断 → [电源保护机制](电源保护机制.md)

## 7. 引脚与典型连线

[📷 _llm/raw/assets/datasheets/tps55288/tps55288_p3_fig1.jpg|460]
*VQFN-HR 封装引脚分布*
...
[📷 _llm/raw/assets/datasheets/tps55288/tps55288_p1_fig2.jpg|560]
*首页典型应用电路（全输入范围 2.7–36V）*

[📷 _llm/raw/assets/datasheets/tps55288/tps55288_p35_fig1.jpg|620]
...
[📷 _llm/raw/assets/datasheets/tps55288/tps55288_p52_fig1.jpg|460]
*RPM0026A 封装机械图*
...
（49.9kΩ + 0.01µF → 约 716Hz，推算。）DITH/SYNC 接地或拉高 >1.2V 即禁用展频；使用外同步时展频自动禁用 → [展频谱与EMI抑制](展频谱与EMI抑制.md)
...
内部等效检流电阻 RSENSE = 0.055Ω，误差放大器跨导 GEA = 190µA/V；CP < 10pF 时可省略。目标相位裕度 >45°、增益裕度 >10dB。原理详见 [环路补偿](环路补偿.md)。
...
---
- [DC-DC降压转换器](DC-DC降压转换器.md) · [展频谱与EMI抑制](展频谱与EMI抑制.md) · [轻载效率模式](轻载效率模式.md) · [电源保护机制](电源保护机制.md) · [环路补偿](环路补偿.md)
