...
[SiC46x](SiC46x.md) 系列降压转换器即采用电压模式 COT 控制，支持外部纹波注入、可编程开关频率（100 kHz - 2 MHz），以及三种工作模式（强制连续、省电、超声波）。

## See Also

- [电源电子/DC-DC降压转换器](电源电子/DC-DC降压转换器.md) — 降压转换器基础
- [SiC46x](SiC46x.md) — 采用 COT 的器件实体页
