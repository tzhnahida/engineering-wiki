...
updated: 2026-07-15
sources:
  - "[2026-07-15 - Bonnabel 不变扩展卡尔曼滤波](../../来源/2026-07-15 - Bonnabel 不变扩展卡尔曼滤波.md)"
...
- [AVNet 不变扩展卡尔曼姿态](AVNet 不变扩展卡尔曼姿态.md) — InEKF + 深度学习的工程应用实例
- [Matrix Fisher SO3概率姿态](Matrix Fisher SO3概率姿态.md) — 另一种处理 SO(3) 不确定性的框架，直接对旋转矩阵概率建模
- [IMU姿态解算算法演进](IMU姿态解算算法演进.md) — 算法全景中 IEKF/InEKF 的位置
- [2026-06-24 - Solà Error-State Kalman Filter](../../2026-06-24 - Solà Error-State Kalman Filter.md) — Error-State KF 原文，与 IEKF 对照理解
